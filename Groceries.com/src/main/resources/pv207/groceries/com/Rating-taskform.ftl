<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("rating");
					i++;
...
<div id="container">
	<div id="header">
		User Task Form: Customer Picks-Up Crate Order.Rating
	</div>
	<div id="content">
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		...
                            		<div class="div_texbox">
                              		<input name="rating" type="text" class="textbox" id="rating" value="${rating}" />
                            		</div>
