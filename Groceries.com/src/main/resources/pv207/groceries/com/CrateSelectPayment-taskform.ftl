<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("type");
					i++;
...
<div id="container">
	<div id="header">
		User Task Form: Customer Picks-Up Crate Order.CrateSelectPayment
	</div>
	<div id="content">
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		...
                            		<div class="div_texbox">
                              		<input name="type" type="text" class="textbox" id="type" value="${type}" />
                            		</div>
